...
$PAGE->requires->js(new moodle_url($CFG->wwwroot.'/local/trend_analysis_report/js/toolbox_talks_by_category.js'));


class toolbox_talks_by_category_filter_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->_formname = "toolbox_talks_by_category_filter_form";
        ...
        $defaulttime = strtotime(date('Y-01-01 00:00:00'));
        ...
        $mform->addElement('html', html_writer:: tag('button','Search',array('type'=>'button','id'=>'toolbox_talks_by_category','class'=>'btn btn-primary','style' =>'margin-right:5px')));
        $mform->addElement('html', html_writer::tag('a', 'Reload', array('href'=>$CFG->wwwroot.'/local/trend_analysis_report/toolbox_talks_by_category.php?m=1_4','class'=>'btn btn-secondary')));
        $mform->addElement('html', html_writer:: end_tag('div'));
