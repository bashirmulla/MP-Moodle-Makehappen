...
$string['pluginname'] = 'Trend Analysis Report';
$string['heading']    = 'Trend Analysis Report';
$string['welcome']    = 'Report page';
$string['success']    = 'Success Page';
$string['targetfile'] = 'Target File';
$string['general']    = 'Upload';
$string['uploadtarget']  = 'Upload Target';
$string['uploadactual']  = 'Upload Actual';
$string['year']          = 'Year';
$string['month']         = 'Month';
$string['save']          = 'Save';
...
//Report - Toolbox Talks by Category
