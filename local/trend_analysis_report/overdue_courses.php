...
require_once(dirname(__FILE__).'/classes/overdue_courses_filter_form.php');  //
...
$title   = get_string('overdue_courses', 'local_'.$pluginname);
$heading = get_string('overdue_courses', 'local_'.$pluginname);
...
$form = new overdue_courses_filter_form(null, array());
