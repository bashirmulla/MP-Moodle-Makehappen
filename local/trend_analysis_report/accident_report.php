...
require_once(dirname(__FILE__).'/classes/accidents_list.php');  // Include form.
...
$title   = get_string('accident', 'local_'.$pluginname);
$heading = get_string('accident', 'local_'.$pluginname);
...
$form = new accidents_list(null, array());
