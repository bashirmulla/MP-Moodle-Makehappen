...
$plugin->component = 'local_mp_report';  // To check on upgrade, that module sits in correct place
$plugin->version   = 2020101000;        // The current module version (Date: YYYYMMDDXX)
