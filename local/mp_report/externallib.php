                ...
                'accident' =>
                    new external_single_structure(
                        array(
                                ...
                                'a_surname'               => new external_value(PARAM_TEXT, 'Plain text puser_address',1),
                                'a_forename'              => new external_value(PARAM_TEXT, 'Plain text user_postcode',1),
                                'a_home_address'          => new external_value(PARAM_TEXT, 'Plain text user_occupation',1),
                                'a_postcode'              => new external_value(PARAM_TEXT, 'Plain text user_contract',1),
                                'a_tel_no'                => new external_value(PARAM_INT, 'id of user_manager',1),
                                'a_sex'                   => new external_value(PARAM_INT, 'timestamp int value user_date',1),
                                'a_age'                   => new external_value(PARAM_TEXT, 'Plain text victim_name',1),
                                'a_following_accident'    => new external_value(PARAM_TEXT, 'Plain text victim_address',1),
                                'a_resumed_work'          => new external_value(PARAM_TEXT, 'Plain text victim_postcode',1),
                                'a_hours'                 => new external_value(PARAM_TEXT, 'Plain text victim_occupation',1),
                                'a_mins'                  => new external_value(PARAM_INT, 'Plain text accident_report_number',1),
                                'a_temp_address'          => new external_value(PARAM_TEXT, 'Plain text accident_place',0),
                                'a_status'                => new external_value(PARAM_TEXT, 'Plain text accident_reason',0),
                                'a_job_title'             => new external_value(PARAM_TEXT, 'Plain text accident_detail',0),
                                'a_injury_condition'      => new external_value(PARAM_TEXT, 'Yes/No enum field accident_witnesses',0),
                                'a_body_affected'         => new external_value(PARAM_TEXT, 'Plain text witnesses_name',0),
                                'a_employers_name'        => new external_value(PARAM_TEXT, 'Plain text witnesses_address',0),
                                'b_date'                  => new external_value(PARAM_TEXT, 'Plain text witnesses_phone_number',0),
                                'b_time'                  => new external_value(PARAM_INT, 'Plain text witnesses_report_date',0),
                                'b_name_address_site'     => new external_value(PARAM_TEXT, 'Plain text witnesses_report_details',0),
                                'b_exact_location_site'   => new external_value(PARAM_TEXT, 'based64 encoded text photo_1',0),
                                'b_dangerous'             => new external_value(PARAM_TEXT, 'based64 encoded text photo_2',0),
                                'b2_date'                 => new external_value(PARAM_TEXT, 'based64 encoded text photo_3',0),
                                'b2_time'                 => new external_value(PARAM_TEXT, 'based64 encoded text photo_4',0),
                                'b_injured'               => new external_value(PARAM_TEXT, 'based64 encoded text photo_5',0),
                                'b_witness'               => new external_value(PARAM_TEXT, 'based64 encoded text photo_6',0),
                                'b_witness_name'          => new external_value(PARAM_INT, 'category id',0),
                                'b_witness_address'       => new external_value(PARAM_TEXT, 'Enum field Yes/No',0),
                                'b_tel_witness'           => new external_value(PARAM_TEXT, 'Enum field Yes/No',0),
                                'c_kind_of_accident'      => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'c_metres'                => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'd_agents'                => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'd_first_aid'             => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'e_accident_state'        => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'f_action_taken'             => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'declaration_name_of_person' => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile'),
                                'declaration_date'           => new external_value(PARAM_TEXT, 'Enum field mobile/web',0,'mobile')
