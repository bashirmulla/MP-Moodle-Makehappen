...
function home_page(){
    ...
    //$form = new accident_report_list(null, array());
...
function accident_edit_form(){
    ...
    $tableName  = get_string('accident_table','local_accident_report');
    $form = new accident_report_form(null, array());
    if ($form->is_cancelled()) {
        redirect($homeurl);
    }
...
function incident_edit_form(){
    ...
    $tableName  = get_string('incident_table','local_accident_report');
    ...
    if(!empty($dataobject) && $form->is_validated()){
        ...
        if(!empty($id) ){
            ...
            if(empty($dataobject->id)) {
                ...
                update_data($updateData, get_string('accident_table', 'local_accident_report'));
                ...
                send_accident_report_email("Makehappen", $subject, $message, pdfs_email_attachment() . $pdf_file, $pdf_file,$report_title);
    ...
    if(!empty($dataobject) && $form->is_validated()){
        ...
        if(!empty($id)){
            if(empty($dataobject->id)) {
                ...
                update_data($updateData, get_string('incident_table', 'local_accident_report'));
...
function accident_pdf($acc_id) {
    ...
    $pdf = new pdf();
    $PDF_HEADER_LOGO       = '/local/accident_report/images/mh_logo_sm.png'; //any image file. check correct path.
...
function accident_full_pdf($acc_id) {
    ...
    <?php if(!empty($data->manager_id)) {?>
        ...
        <tr >
            <th colspan="4"><?= get_string('manager_name', 'local_accident_report')?></th>
        </tr>
        <tr>
        ...
        <table width="100%" class="data-table"  >
            <tr>
                <th colspan="4"><?= get_string('accident_additional_details','local_accident_report')?></th>
            </tr>
            <tr>
        ...
        <table width="100%" class="data-table"  >
            <tr>
                <th colspan="4"><?= get_string('additional_details','local_accident_report')?></th>
            </tr>
            <tr>
        ...
        <table width="100%" class="data-table"  style="page-break-inside:avoid">
            <tr>
                <th colspan="4"><?= get_string('root_cause','local_accident_report')?></th>
            </tr>
            <tr>
        ...
        <table width="100%" class="data-table"  style="page-break-inside:avoid">
            <tr>
                <th colspan="4"><?= get_string('immediate_action','local_accident_report')?></th>
            </tr>
            <tr>
        ...
        <table width="100%" class="data-table"  style="page-break-inside:avoid">
            <tr>
                <th  colspan="4"><?= get_string('further_action_required','local_accident_report')?></th>
            </tr>
            <tr>
        ...
        <table width="100%" class="data-table"  style="page-break-inside:avoid">
            <tr>
                <th width="15%"><?= get_string('lost_time','local_accident_report')?></th>
                <td width="35%"><?= $data->lost_time?></td>
                <th width="15%"><?= get_string('lost_time_days','local_accident_report')?></th>
                <td width="35%"><?= $data->lost_time_days?></td>
            </tr>
            <tr>
                <th><?= get_string('mgt_review_report_date','local_accident_report')?></th>
                <td><?= date('d-M-Y',$data->mgt_review_report_date)?></td>
                <th><?= get_string('mgt_review_status','local_accident_report')?></th>
        ...
        <table width="100%" class="data-table"  style="page-break-inside:avoid">
            <tr>
                <th colspan="4"><?= get_string('mgt_review_comments','local_accident_report')?></th>
            </tr>
            <tr>
    ...
    if (!empty($data->s_mgt_rpt_report_date)){
        if(!empty($data->manager_id) and (is_senior_manager() or is_complieance() or is_admin())) {
            ...
            <table width="100%" class="data-table" style="page-break-inside:avoid">
                <tr>
                    <th width="15%"><?= get_string('s_mgt_rpt_name', 'local_accident_report')?></th>
                    <td width="35%"><?= $senior_manager_list[$data->s_mgt_rpt_name]?></td>
                    <th width="15%"><?= get_string('s_mgt_rpt_report_date','local_accident_report')?></th>
                    <td width="35%"><?= date('d-M-Y',$data->s_mgt_rpt_report_date)?></td>
                </tr>
            </table>
            <table width="100%" class="data-table" style="page-break-inside:avoid">
                <tr>
                    <th><?= get_string('s_mgt_rpt_comments','local_accident_report')?></th>
                </tr>
                <tr>
            ...
            <table width="100%" class="data-table" style="page-break-inside:avoid">
                <tr>
                    <th><?= get_string('s_mgt_rpt_f_action','local_accident_report')?></th>
                </tr>
                <tr>
            ...
            <table width="100%" class="data-table" style="page-break-inside:avoid">
                <tr>
                    <th><?= get_string('s_mgt_rpt_f_a_comment','local_accident_report')?></th>
                    <td><?= $data->s_mgt_rpt_f_a_comment?></td>
                </tr>
            </table>
            <table width="100%" class="data-table" style="page-break-inside:avoid">
                <tr>
                    <th><?= get_string('s_mgt_rpt_2508_completed','local_accident_report')?></th>
                    <td><?= $dropdown['yes_no'][$data->s_mgt_rpt_2508_completed]?></td>
                </tr>
            </table>
            <table width="100%" class="data-table" style="page-break-inside:avoid">
                <tr>
                    <th><?= get_string('s_mgt_rpt_2508_cpt_date','local_accident_report')?></th>
                    <td><?= date('d-M-Y',$data->s_mgt_rpt_2508_cpt_date)?></td>
                    <th><?= get_string('s_mgt_rpt_riddor_event_clf','local_accident_report')?></th>
                    <td><?= $dropdown['riddor_classification'][$data->s_mgt_rpt_riddor_event_clf]?></td>
                </tr>
                <tr>
                    <th><?= get_string('s_mgt_rpt_riddor_subcategory','local_accident_report')?></th>
                    <td><?= $dropdown['RIDDOR_subcategory'][$data->riddor_subcategory]?></td>
                    <th><?= get_string('s_mgt_rpt_reported_en_a','local_accident_report')?></th>
                    <td><?= $dropdown['yes_no'][$data->s_mgt_rpt_reported_en_a]?></td>
                </tr>
                <tr>
                    <th><?= get_string('s_mgt_rpt_reported_en_a_date','local_accident_report')?></th>
                    <td><?= date('d-M-Y',$data->s_mgt_rpt_reported_en_a_date)?></td>
                    <th><?= get_string('s_mgt_rpt_sr_mgr_notified','local_accident_report')?></th>
                    <td><?= $dropdown['yes_no'][$data->s_mgt_rpt_sr_mgr_notified]?></td>
                </tr>
                <tr>
                    <th><?= get_string('s_mgt_rpt_sr_mgr_notified_date','local_accident_report')?></th>
                    <td><?= date('d-M-Y',$data->s_mgt_rpt_sr_mgr_notified_date)?></td>
                    <th><?= get_string('s_mgt_rpt_in_br_informed','local_accident_report')?></th>
                    <td><?= $dropdown['yes_no'][$data->s_mgt_rpt_in_br_informed]?></td>
                </tr>
                <tr>
                    <th><?= get_string('s_mgt_rpt_ant_closed_off','local_accident_report')?></th>
                    <td><?php if($data->s_mgt_rpt_ant_closed_off==1) echo "Yes";else echo  "No";?></td>
                    <th><?= get_string('s_mgt_rpt_ant_closed_off_date','local_accident_report')?></th>
        ...
        if (!empty($data->is_correct_report_category)) {
            ...
            <tr>
                <td>
                    ...
                    <table width="100%" class="data-table">
                        <tr class="even">
                            <th width="15%"><?= get_string('is_correct_report_category', 'local_accident_report') ?></th>
                            <td width="35%"><?= $data->is_correct_report_category; ?></td>
                            <th width="15%"><?= get_string('correct_report_category', 'local_accident_report') ?></th>
                            <td width="35%"><?= $dropdown2['report_category'][$data->correct_report_category] ?></td>

                        </tr>
                        <tr>
                            <th><?= get_string('classification', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['classification'][$data->classification] ?></td>
                            <th><?= get_string('categorisation', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['categorisation'][$data->categorisation] ?></td>
                        </tr>
                        <tr>
                            <th><?= get_string('vehicles', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['vehicle'][$data->vehicles] ?></td>
                            <th><?= get_string('equipment', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['equipment'][$data->equipment] ?></td>
                        </tr>
                        <tr>
                            <th><?= get_string('environmental', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['environment'][$data->environmental] ?></td>
                            <th><?= get_string('attack', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['attack'][$data->action_taken] ?></td>
                        </tr>
                        <tr>
                            <th><?= get_string('further_action', 'local_accident_report') ?></th>
                            <td colspan="3"><?= $data->further_action ?></td>
                        </tr>
                        <tr>
                            <th><?= get_string('lost_time', 'local_accident_report') ?></th>
                            <td><?= $data->lost_time; ?></td>
                            <th><?= get_string('lost_time_days', 'local_accident_report') ?></th>
                            <td><?= $data->lost_time_days ?></td>

                        </tr>
                        <tr>
                            <th><?= get_string('report_to_client', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['yes_no'][$data->report_to_client] ?></td>
                            <th><?= get_string('report_priority', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['report_priority'][$data->report_priority] ?></td>

                        </tr>
                        <tr>
                            <th><?= get_string('contact_details', 'local_accident_report') ?></th>
                            <td colspan="3"><?= $data->contact_details; ?></td>
                        </tr>
                        <tr>
                            <th><?= get_string('meeting_date', 'local_accident_report') ?></th>
                            <td><?= date("d-M-Y",$data->meeting_date) ?></td>
                            <th><?= get_string('added_to_rvt_calm_system', 'local_accident_report') ?></th>
                            <td><?= $dropdown2['calm_systems'][$data->added_to_rvt_calm_system] ?></td>
                        </tr>
                        <tr>
                            <th><?= get_string('report_closed', 'local_accident_report') ?></th>
    ...
    if(!empty($data->manager_id)  and (is_complieance() or is_admin() ) ) {
        ...
        <tr>
            <td>
                ...
                <table width="100%" class="data-table">
                    <tr class="even">
                        <th><?= get_string('reviewer', 'local_accident_report') ?></th>
                        <td><?= $compliance_list[$data->compliance_id] ?></td>
                        <th><?= get_string('change_required', 'local_accident_report') ?></th>
                    ...
                    <tr>
                        ...
                        <th><?= get_string('details_change_required', 'local_accident_report') ?></th>
