<?php
$functions = array(
    'local_accident_report_get_standing_table' => array(         //web service function name
        'classname'   => 'local_accident_report_external',       //class containing the external function
        'methodname'  => 'get_standing_table',               //external function name
        'classpath'   => 'local/accident_report/externallib.php',//file containing the class/external function
    ...
    'local_accident_report_get_email_table' => array(         //web service function name
        'classname'   => 'local_accident_report_external',       //class containing the external function
    ...
    'local_accident_report_get_manager_list' => array(           //web service function name
        'classname'   => 'local_accident_report_external',       //class containing the external function
    ...
    'local_accident_report_create_accident' => array(             //web service function name
        'classname'   => 'local_accident_report_external',        //class containing the external function
    ...
    'local_accident_report_create_incident' => array(             //web service function name
        'classname'   => 'local_accident_report_external',        //class containing the external function
