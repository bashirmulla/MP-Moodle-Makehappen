...
class incident_report_form extends moodleform {
    ...
    public function userPartForm(){
        ...
        $mform->addElement('select', 'contact', get_string('i_contact', 'local_accident_report'), createDropdown($dropdown['contract']));
        $mform->setType('contact', PARAM_TEXT);
        $mform->addRule('contact', get_string('required'), 'required');

        $mform->addElement('select', 'manager', get_string('i_manager', 'local_accident_report'), get_com_manager_list());
        $mform->setType('manager', PARAM_TEXT);
        $mform->addRule('manager', get_string('required'), 'required');

        $mform->addElement('date_time_selector', 'i_date', get_string('i_date', 'local_accident_report'), 'maxlength="100" size="40" ');
        ...
        $mform->addGroup($radioarray, 'day_night', get_string('day_night', 'local_accident_report'), array(' '), false);
        $mform->addRule('day_night', get_string('required'), 'required');

        $mform->addElement('text', 'location', get_string('location', 'local_accident_report'), 'maxlength="100" size="40" ');
        ...
        $mform->addGroup($radioarray, 'lone_worker', get_string('lone_worker','local_accident_report'), array(' '), false);
        $mform->addRule('lone_worker', get_string('required'), 'required','','client');

        $mform->addElement('textarea', 'what_observe', get_string('what_observe', 'local_accident_report'), 'wrap="virtual" maxlength="2000" rows="6" cols="40"');
        $mform->setType('what_observe', PARAM_TEXT);
        $mform->addHelpButton('what_observe', "max_length",'local_accident_report');
        ...
        $mform->addElement('html', html_writer:: tag('label',get_string('max_length','local_accident_report'),array('for'=>'help_text','class'=>'helptext col-md-10')));
        $mform->addElement('html', html_writer:: end_tag('div'));


        $mform->addElement('file', 'photo_1', get_string('photo_1', 'local_accident_report'), 'accept="image/*" maxlength="200" size="40" ');
        $mform->setType('photo_1', PARAM_FILE);
        $mform->addRule('photo_1', get_string('required'), 'required');

        $mform->addElement('file', 'photo_2', get_string('photo_2', 'local_accident_report'), 'accept="image/*" maxlength="200" size="40" ');
        $mform->setType('photo_2', PARAM_FILE);
        $mform->addRule('photo_2', get_string('required'), 'required');

        $mform->addElement('file', 'photo_3', get_string('photo_3', 'local_accident_report'), 'accept="image/*" maxlength="200" size="40" ');
        $mform->setType('photo_3', PARAM_FILE);
        $mform->addElement('file', 'photo_4', get_string('photo_4', 'local_accident_report'), 'accept="image/*" maxlength="200" size="40" ');
        $mform->setType('photo_4', PARAM_FILE);
        $mform->addElement('file', 'photo_5', get_string('photo_5', 'local_accident_report'), 'accept="image/*" maxlength="200" size="40" ');
        $mform->setType('photo_5', PARAM_FILE);
        $mform->addElement('file', 'photo_6', get_string('photo_6', 'local_accident_report'), 'accept="image/*" maxlength="200" size="40" ');
        $mform->setType('photo_6', PARAM_FILE);



        $mform->addElement('textarea', 'action_taken', get_string('action_taken', 'local_accident_report'), 'wrap="virtual" maxlength="500" rows="6" cols="40"');
        $mform->setType('action_taken', PARAM_TEXT);
        $mform->addRule('action_taken', get_string('required'), 'required');
        $mform->addHelpButton('action_taken', "max500_length",'local_accident_report');

        $mform->addElement('html', html_writer:: start_tag('div',array('class'=>'form-group col-lg-8 form-group-ele')));
        $mform->addElement('html', html_writer:: tag('label',get_string('max500_length','local_accident_report'),array('for'=>'help_text','class'=>'helptext col-md-10')));
        $mform->addElement('html', html_writer:: end_tag('div'));

        $mform->addElement('textarea', 'what_could_happened', get_string('what_could_happened', 'local_accident_report'), 'wrap="virtual" maxlength="500" rows="6" cols="40"');
        $mform->setType('what_could_happened', PARAM_TEXT);
        $mform->addRule('what_could_happened', get_string('required'), 'required');
        $mform->addHelpButton('what_could_happened', "max500_length",'local_accident_report');

        $mform->addElement('html', html_writer:: start_tag('div',array('class'=>'form-group col-lg-8 form-group-ele')));
        $mform->addElement('html', html_writer:: tag('label',get_string('max500_length','local_accident_report'),array('for'=>'help_text','class'=>'helptext col-md-10')));
        $mform->addElement('html', html_writer:: end_tag('div'));

        $mform->addElement('select', 'report_category', get_string('report_category', 'local_accident_report'), createDropdown($dropdown['report_category']),'width="100% !important"');
    ...
    public function userPartView($reportData)
    {
        ...
        //$mform->addElement('static', 'report_number1', get_string('i_report_number', 'local_accident_report'), $reportData->report_number);
        $mform->addElement('static', 'name1', get_string('name', 'local_accident_report'),$user->firstname.' '.$user->lastname );

        $mform->addElement('static', 'contact1', get_string('i_contact', 'local_accident_report'), $dropdown['contract'][$reportData->contact]);

        $mform->addElement('static', 'manager1', get_string('i_manager', 'local_accident_report'), @$managerList[$reportData->manager]);
        $mform->addElement('static', 'i_date1', get_string('i_date', 'local_accident_report'), date("d-M-Y G:i:s", $reportData->i_date));
        $mform->addElement('static', 'day_night1', get_string('day_night', 'local_accident_report'), $reportData->day_night);
        $mform->addElement('static', 'location1', get_string('location', 'local_accident_report'), $reportData->location);
        $mform->addElement('static', 'lone_worker1', get_string('lone_worker', 'local_accident_report'), $reportData->lone_worker);
        $mform->addElement('static', 'what_observe1', get_string('what_observe', 'local_accident_report'), $reportData->what_observe);
        ...
        $mform->addElement('static', 'action_taken1', get_string('action_taken', 'local_accident_report'),$reportData->action_taken);
        $mform->addElement('static', 'what_could_happened1  ', get_string('what_could_happened', 'local_accident_report'),$reportData->what_could_happened);
        $mform->addElement('static', 'contact1', get_string('report_category', 'local_accident_report'), $dropdown['report_category'][$reportData->report_category]);
    ...
    public function managerPartForm($reportData){
        ...
        $mform->addGroup($radioarray, 'is_correct_report_category', get_string('is_correct_report_category','local_accident_report'), array(''), false);
        ...
        $mform->addElement('select', 'correct_report_category', get_string('correct_report_category', 'local_accident_report'), createDropdown($dropdown['report_category']),'width="100% !important"');
        ...
        $mform->addElement('select', 'classification', get_string('classification', 'local_accident_report'), createDropdown($dropdown['classification']),'width="100% !important"');
        $mform->setType('classification', PARAM_TEXT);
        $mform->setDefault('classification', $reportData->classification);


        $mform->addElement('select', 'categorisation', get_string('categorisation', 'local_accident_report'), createDropdown($dropdown['categorisation']),'id="categorisation" width="100% !important"');
        ...
        $mform->addElement('select', 'vehicles', get_string('vehicles', 'local_accident_report'), createDropdown($dropdown['vehicle']),'id="vehicle" width="100% !important"');
        $mform->setType('vehicles', PARAM_TEXT);
        $mform->setDefault('vehicles', $reportData->vehicles);

        $mform->addElement('select', 'equipment', get_string('equipment', 'local_accident_report'), createDropdown($dropdown['equipment']),'id="equipment" width="100% !important"');
        $mform->setType('equipment', PARAM_TEXT);
        $mform->setDefault('equipment', $reportData->equipment);


        $mform->addElement('select', 'environmental', get_string('environmental', 'local_accident_report'), createDropdown($dropdown['environment']),'id="environment" width="100% !important"');
        $mform->setType('environmental', PARAM_TEXT);
        $mform->setDefault('environmental', $reportData->environmental);

        $mform->addElement('select', 'attack', get_string('attack', 'local_accident_report'), createDropdown($dropdown['attack']),'id="attack" width="100% !important"');
        $mform->setType('attack', PARAM_TEXT);
        $mform->setDefault('attack', $reportData->attack);

        $mform->addElement('textarea', 'further_action', get_string('further_action', 'local_accident_report'), 'wrap="virtual" maxlength="2000" rows="6" cols="40"');
        $mform->setType('further_action', PARAM_TEXT);
        $mform->addHelpButton('further_action', "max_length",'local_accident_report');
        ...
        $mform->addElement('text', 'lost_time_days', get_string('lost_time_days', 'local_accident_report'), 'id="lost_time_days" maxlength="3" size="10" ');
        ...
        $mform->addElement('select', 'report_to_client', get_string('report_to_client', 'local_accident_report'), $dropdown['yes_no']);
        ...
        $mform->addElement('select', 'report_priority', get_string('report_priority', 'local_accident_report'), createDropdown($dropdown['report_priority']));
        $mform->setType('report_priority', PARAM_TEXT);
        $mform->setDefault('report_priority', $reportData->report_priority);

        $mform->addElement('textarea', 'contact_details', get_string('contact_details', 'local_accident_report'), 'wrap="virtual" maxlength="2000" rows="6" cols="40"');
        $mform->setType('contact_details', PARAM_TEXT);
        $mform->addHelpButton('contact_details', "max_length",'local_accident_report');
        ...
        $mform->addElement('date_selector', 'meeting_date', get_string('meeting_date', 'local_accident_report'), 'maxlength="100" size="40" ');
        ...
        $mform->addElement('select', 'added_to_rvt_calm_system', get_string('added_to_rvt_calm_system', 'local_accident_report'), createDropdown($dropdown['calm_systems']));
        ...
        $mform->addGroup($radioarray, 'report_closed', get_string('report_closed','local_accident_report'), array(''), false);
        ...
        if(!empty($reportData->manager_id)  and (is_complieance() or is_admin() ) ) { // @to do: need to discuss with @SAM for manager_id,manager in same table and both are contains user id
            ...
            $mform->addElement('select', 'compliance_id', get_string('reviewer', 'local_accident_report'), createDropdown(get_compliance_list()));
            ...
            $mform->addGroup($radioarray, 'change_required', get_string('change_required', 'local_accident_report'), array(''), false);
            $mform->setDefault('change_required', $reportData->change_required);


            $mform->addElement('textarea', 'details_change_required', get_string('details_change_required', 'local_accident_report'), 'wrap="virtual" maxlength="2000" rows="6" cols="40"');
            ...
            $mform->addHelpButton('details_change_required', "max_length",'local_accident_report');
    ...
    public function managerPartView($reportData){
        ...
        $mform->addElement('html', '<fieldset class="scheduler-border"><legend class="scheduler-border">Management Review</legend>');
        $mform->addElement('static', 'is_correct_report_category', get_string('is_correct_report_category', 'local_accident_report'), $reportData->is_correct_report_category);
        $mform->addElement('static', 'correct_report_category', get_string('correct_report_category', 'local_accident_report'), $reportData->correct_report_category);
        $mform->addElement('static', 'classification', get_string('classification', 'local_accident_report'), $dropdown['classification'][$reportData->classification]);
        $mform->addElement('static', 'categorisation', get_string('categorisation', 'local_accident_report'), $dropdown['categorisation'][$reportData->categorisation]);
        $mform->addElement('static', 'vehicle', get_string('vehicles', 'local_accident_report'), $dropdown['vehicle'][$reportData->vehicles]);
        $mform->addElement('static', 'equipment', get_string('equipment', 'local_accident_report'), $dropdown['equipment'][$reportData->equipment]);
        $mform->addElement('static', 'environmental', get_string('environmental', 'local_accident_report'), $dropdown['environmental'][$reportData->equipment]);
        $mform->addElement('static', 'attack', get_string('attack', 'local_accident_report'), $dropdown['attack'][$reportData->attack]);
        $mform->addElement('static', 'further_action', get_string('further_action', 'local_accident_report'), $reportData->further_action);
        ...
        $mform->addElement('static', 'report_to_client', get_string('report_to_client', 'local_accident_report'), $dropdown['yes_no'][$reportData->report_to_client]);
        $mform->addElement('static', 'report_priority', get_string('report_priority', 'local_accident_report'), $dropdown['report_priority'][$reportData->report_priority]);
        $mform->addElement('static', 'contact_details', get_string('contact_details', 'local_accident_report'), $reportData->contact_details);
        $mform->addElement('static', 'meeting_date', get_string('meeting_date', 'local_accident_report'), date('d-M-Y',$reportData->meeting_date));
        $mform->addElement('static', 'added_to_rvt_calm_system', get_string('added_to_rvt_calm_system', 'local_accident_report'), $dropdown['calm_systems'][$reportData->added_to_rvt_calm_system]);
        $mform->addElement('static', 'report_closed', get_string('report_closed', 'local_accident_report'), $reportData->report_closed);
        ...
        if(!empty($reportData->manager_id)  and (is_complieance() or is_admin() ) ) { // @to do: need to discuss with @SAM for manager_id,manager in same table and both are contains user id
            ...
            $mform->addElement('static', 'reviewer', get_string('reviewer', 'local_accident_report'), $compliance_list[$reportData->compliance_id]);
            $mform->addElement('static', 'change_required', get_string('change_required', 'local_accident_report'), $reportData->change_required);
            $mform->addElement('static', 'details_change_required', get_string('details_change_required', 'local_accident_report'), $reportData->details_change_required);
    ...
    public function definition() {
        ...
        $heading = '<h3 style="text-align: center">'.get_string('incident', 'local_accident_report');

        $report_closed = FALSE;
        if(isset($_REQUEST['id']) && $_REQUEST['cmd']=='inc_edit' && (is_senior_manager() || is_complieance() || is_admin() || is_manager())) {
            $reportData = get_data(array("id"=>$_REQUEST['id']),get_string('incident_table','local_accident_report'));
            ...
            if( is_senior_manager() || is_complieance() || is_admin() || is_manager()) {
                ...
                <div class="col-sm-6">
                    <h3 id="report_headding">'.get_string('incident', 'local_accident_report').'</h3>
                 </div>
                <div class="col-sm-6" style="text-align: right !important;">     
                     ...
                     <a class="btn btn-dark" style="background-color: #0a4e8a; border-color: #0a4e8a !important;" href="index.php?cmd=inc_pdf&id='.$_REQUEST['id'].'&download=1&catID='.$reportData->report_category.'&uid='.$reportData->user_id.'&d='.$reportData->i_date.'"><i class="fa fa-check-circle"> </i> Export Initial Report as PDF </a>
