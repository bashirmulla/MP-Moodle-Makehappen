...
class accident_report_list extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html',get_string('welcome', 'local_accident_report'));

        $buttonarray = array();
        $buttonarray[] = $mform->createElement('button', 'add', get_string('buttonadd', 'local_accident_report'),array("id"=>"add"));
...
class accident_page extends moodleform {
    ...
    public function accident_report_list() {
        ...
        $mform->addElement('html','
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="ccnMdlHeading">'.get_string('accident', 'local_accident_report')."s</h4>
                 </div>
                  <div class='col-sm-4' style='text-align: right !important;'>  
                     <a class='btn btn-dark' style='background-color: #fcc42c; border-color: #fcc42c !important; ' href='/local/accident_report/index.php'><i class='fa fa-backward'> </i> Back </a>
                    
                     <a class='btn btn-dark' style='background-color: #2441e7; border-color: #2441e7 !important;' href='/local/accident_report/index.php?cmd=form1'><i class='fa fa-plus-circle'> </i> Add Accident</a>
                 </div>
             </div>    
            <hr>");
...
class incident_page extends moodleform {
    ...
    public function incident_report_list() {
        ...
        $mform->addElement('html','
            <div class="row" >
                <div class="col-sm-8">
                    <h4 class="ccnMdlHeading">'.get_string('incident', 'local_accident_report')."s</h4>
                 </div>
                <div class='col-sm-4' style='text-align: right !important;'>     
                     <a class='btn btn-dark' style='background-color: #fcc42c; border-color: #fcc42c !important;' href='/local/accident_report/index.php'><i class='fa fa-backward'> </i> Back </a>
                
                     <a class='btn btn-dark' style='background-color: #2441e7; border-color: #2441e7 !important;' href='/local/accident_report/index.php?cmd=form2'><i class='fa fa-plus-circle'> </i> Add Incident</a>
                 </div>
             </div>    
            <hr>");
    ...
    public function definition() {
        ...
        $html = '<div class="row justify-content-center" style="text-align: center !important;">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-lg-5th-1">
					<a href="/local/accident_report/index.php?cmd=accpage" data-ccn-c="color3" data-ccn-co="bg" class="icon_hvr_img_box ccn-color-cat-boxes" style="background:rgba(0, 97, 255, 0.6);">
						<div class="overlay">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-lg-5th-1">
					<a href="/local/accident_report/index.php?cmd=incpage" data-ccn-c="color4" data-ccn-co="bg" class="icon_hvr_img_box ccn-color-cat-boxes" style="background:rgba(241, 67, 45, 0.6);">
						<div class="overlay">
