...
CREATE TABLE `mdl_accident_report` (
  ...
  `witnesses_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `witnesses_address` longtext COLLATE utf8mb4_unicode_ci,
  `witnesses_phone_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `mdl_incident_report` (
  `id` bigint(10) NOT NULL,
  `user_id` bigint(10) NOT NULL,
  `report_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `mdl_standing_table`
  MODIFY `id` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
